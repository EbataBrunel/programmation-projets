...
urlpatterns=[
    ...
    path("contact_admin_detail/<str:customer>/<int:id>", contact_admin_detail, name="contact_admin_detail"),
    path("add-contact", add_contact, name="add_contact"),
    path("del-contact/<int:id>", del_contact, name="del_contact"),
    ...
    path("detail-message/<int:id>", detail_message, name="detail_message"),
