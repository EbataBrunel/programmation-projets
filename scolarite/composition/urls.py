...
urlpatterns=[
    ...
    path("detail_cmp_salle/<int:id>", detail_cmp_salle, name="detail_cmp_salle"),
    path("detail_cmp_trimestre/<int:salle_id>/<str:trimestre>", detail_cmp_trimestre, name="detail_cmp_trimestre"),
    path("detail_comp_student/<int:salle_id>/<str:trimestre>/<int:student_id>", detail_comp_student, name="detail_comp_student"),
    path("detail_comp_matiere/<int:salle_id>/<str:trimestre>/<int:matiere_id>", detail_comp_matiere, name="detail_comp_matiere"),
    ...
    path("edit_composition/<int:id>/<str:param>", edit_composition, name="edit_composition"),
    ...
    path("del_composition/<int:id>", del_composition, name="del_composition"),
    ...
    path("gestion-etude-parent-detail/<int:student_id>", gestion_etude_parent_detail, name="gestion_etude_parent_detail"),
    
    path("cmp_teacher", cmp_teacher, name="cmp_teacher"),
    path("detail_cmpteacher/<int:salle_id>/<int:matiere_id>/<str:trimestre>", detail_cmpteacher, name="detail_cmpteacher"),
    ...
    path("bulletin-etudiant/<int:student_id>/<str:trimestre>", bulletin_etudiant, name="bulletin_etudiant"),
    path("proces_verbal_examen/<int:salle_id>/<str:trimestre>", proces_verbal_examen, name="proces_verbal_examen"),
    ...
    path("releve_note_controle/<int:salle_id>/<int:matiere_id>/<str:num_controle>/<str:trimestre>", releve_note_controle, name="releve_note_controle"),
    path("releve_note_examen/<int:salle_id>/<int:matiere_id>/<str:trimestre>", releve_note_examen, name="releve_note_examen"),
