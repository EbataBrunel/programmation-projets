...
urlpatterns=[
    ...
    path("recap_emargement/<int:enseignant_id>/<str:month>", recap_emargement, name="recap_emargement"),
    path("add_renumeration/<int:enseignant_id>/<str:month>", add_renumeration, name="add_renumeration"),
    ...
    path("contrat/edit_contrat/<int:id>", edit_contrat, name="contrat/edit_contrat"),
    path("edit_ct", edit_ct, name="edit_ct"),
    path("del_contrat/<int:id>", del_contrat, name="del_contrat"),
    ...
    path("ajax_delete_contrat/<int:id>", ajax_delete_contrat, name="ajax_delete_contrat"),
    ...
    path("renum/edit_renum_admin/<int:id>", edit_renum_admin, name="renum/edit_renum_admin"),
    path("edit_ra", edit_ra, name="edit_ra"),
    path("del_renum_admin/<int:id>", del_renum_admin, name="del_renum_admin"),
    path("renum/mes_renum_admin", mes_renum_admin, name="renum/mes_renum_admin"),
    path("ajax_delete_renum_admin/<int:id>", ajax_delete_renum_admin, name="ajax_delete_renum_admin"),
    ...
    path("ajax_user_month_contrat/<int:user_id>", ajax_user_month_contrat, name="ajax_user_month_contrat"),
    path("edit_renum_admin/ajax_user_month_contrat/<int:user_id>", ajax_user_month_contrat, name="ajax_user_month_contrat"),
    path("ajax_user_amount/<int:user_id>/<str:month>", ajax_user_amount, name="ajax_user_amount"),
    ...
    path("bulletin-paie-enseignant/<int:id>", bulletin_paie_enseignant, name="bulletin_paie_enseignant"),
    path("bulletin-paie-admin/<int:id>", bulletin_paie_admin, name="bulletin_paie_admin")
]