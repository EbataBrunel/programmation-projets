...
urlpatterns=[
    ...
    path("detail_salle/<int:classe_id>", detail_salle, name="detail_salle"),
    path("add_salle", add_salle, name="add_salle"),
    path("edit_salle/<int:id>", edit_salle, name="edit_salle"),
    path("edit_sl", edit_sl, name="edit_sl"),
    path("del_salle/<int:id>", del_salle, name="del_salle"),
    path("delete_salle/<int:id>", delete_salle, name="delete_salle"),
