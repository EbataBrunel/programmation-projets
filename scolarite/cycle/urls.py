...
urlpatterns = [
    ...
    path("edit_cycle/<int:id>", edit_cycle, name="edit_cycle"),
    path("edit_cy/", edit_cy, name="edit_cy"),
    path("del_cycle/<int:id>", del_cycle, name="del_cycle"),
    path("delete_cycle/<int:id>", delete_cycle, name="delete_cycle")
]
