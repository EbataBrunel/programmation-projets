...
def add_cycle(request):
    ...
    if request.method == "POST":
        ...
        query = Cycle.objects.filter(libelle=libelle, anneeacademique_id=anneeacademique_id)
...
def edit_cy(request):
    ...
    if request.method == "POST":
        ...
        if cycle == None:
            ...
            cycles = Cycle.objects.filter(anneeacademique_id=anneeacademique_id).exclude(id=id)
            tabCycles = []
            for c in cycles:          
