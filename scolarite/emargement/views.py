...
def salles_emargements(request, enseignant_id):
    ...
    salles_emargements = (Emargement.objects.values("salle_id")
                  .filter(anneeacademique_id=anneeacademique_id, enseignant_id=enseignant_id)
    ...
    for se in salles_emargements:
        ...
        matieres_emargements = (Emargement.objects.values("matiere_id")
                  .filter(anneeacademique_id=anneeacademique_id, enseignant_id=enseignant_id, salle_id=se["salle_id"])
...
def matieres_emargements(request, enseignant_id, salle_id):
    ...
    matieres_emargements = (Emargement.objects.values("matiere_id")
                  .filter(anneeacademique_id=anneeacademique_id, enseignant_id=enseignant_id, salle_id=salle_id)
                  .annotate(nb_emargements=Count("matiere_id")))
    ...
    for me in matieres_emargements:
        ...
        months_emargements = (Emargement.objects.values("month")
                               .filter(anneeacademique_id=anneeacademique_id, enseignant_id=enseignant_id, matiere_id=me["matiere_id"])
...
def months_emargements(request, enseignant_id, salle_id, matiere_id):
    ...
    months_emargements = (Emargement.objects.values("month")
                  .filter(anneeacademique_id=anneeacademique_id, enseignant_id=enseignant_id, salle_id=salle_id, matiere_id=matiere_id)
