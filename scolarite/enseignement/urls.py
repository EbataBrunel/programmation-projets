...
urlpatterns=[
    ...
    path("trim_enseignement/<int:salle_id>", trim_enseignement, name="trim_enseignement"),
    path("detail_enseignement/<int:salle_id>/<str:trimestre>", detail_enseignement, name="detail_enseignement"),
    path("add_enseignement", add_enseignement, name="add_enseignement"),
    path("edit_enseignement/<int:id>", edit_enseignement, name="edit_enseignement"),
    path("edit_en", edit_en, name="edit_en"),
    path("del_enseignement/<int:id>", del_enseignement, name="del_enseignement"),
    ...
    path("droit_eval/<int:id>", droit_eval, name="droit_eval"),
