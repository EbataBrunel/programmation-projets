...
urlpatterns=[
    ...
    path("edit_matiere/<int:id>", edit_matiere, name="edit_matiere"),
    path("edit_mt/", edit_mt, name="edit_mt"),
    path("del_matiere/<int:id>", del_matiere, name="del_matiere"),
    path("delete_matiere/<int:id>", delete_matiere, name="delete_matiere")
]
